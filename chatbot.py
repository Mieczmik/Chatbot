# Prowadzisz krótki dialog z botem, a następnie oceniasz,
# jak bardzo usatysfakcjonowany jesteś z rozmowy w skali do 100.
# Algorytm bierze k najlepiej ocenionych dialogów i mutuje je zamieniając
# jedno zdanie w dowolnym miejscu konwersacji.
# Koniec następuje, jak dasz 100!
...
how_many = 4
top_k_robots = 2
how_many_responses = len(possible_responses) # number of possible_responses

# Losuje libczy z przedziału 0 do liczby odpowiedzi i generuje macierz z listami o długości "possible_responses"
def generate_new() -> np.ndarray:
    robots = np.random.randint(0, how_many_responses, size=(how_many, how_many_responses))
    return robots


# Zamienia losową odpowiedź na na losowym miejscu na inną
def mutate(robot):
...
# Tworzy zbiór "robotów" z k-najlepszych i k-najlepszych zmutowanych przez funkcję "mutate"
